...
Portable.RemoteTasks.Manager.exe -w -id -s Assemble asmListing !asmListing! definitionFile !defFile! archName !archName! sourcesDir src stdoutRegStName !stdoutRegStName! stdinRegStName !stdinRegStName! > tmp.txt
